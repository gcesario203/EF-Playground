...
namespace Hdogs.api.Migrations
{
    ...
    [Migration("20220320173644_firstV4")]
            ...
            modelBuilder.Entity("Hdogs.api.Model.Entity.Admin", b =>
                {
                    ...
                    b.Property<long>("auth_data_id")
                        .HasColumnType("bigint")
                        .HasColumnName("auth_data_id1");

                    b.HasKey("Id");

                    b.HasIndex("auth_data_id");
            ...
            modelBuilder.Entity("Hdogs.api.Model.Entity.Service", b =>
                {
                    ...
                    b.Property<long>("monitor_id")
                        .HasColumnType("bigint")
                        .HasColumnName("monitor_id1");
